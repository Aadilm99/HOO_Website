...
public class Hippolyta extends Hero {
	...
	public Hippolyta(Sprite s, TiledMapTileLayer collisionLayer) {
	...
	public Sprite ownLogic() {
		  ...
		  texture = new Texture(Gdx.files.internal("hippolyta5.png"));
	...
	public Animation<TextureRegion> takeAction() {
		...
		// Load the sprite sheet as a Texture
			walkSheet = new Texture(Gdx.files.internal("hippolyta5.png"));
	...
	public Sprite attacknow() {
		 ...
		 texture = new Texture(Gdx.files.internal("hippolytaanim.png"));
		   sprite = new Sprite(texture,0,0,64,64);
		   sprite.flip(false, true);
