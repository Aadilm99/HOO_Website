...
public class Theseus extends Hero {
	...
	public Theseus(Sprite s, TiledMapTileLayer collisionLayer) {
	...
	public Sprite ownLogic() {
		  ...
		  texture = new Texture(Gdx.files.internal("theseus5.png"));
	...
	public Animation<TextureRegion> takeAction() {
		...
		// Load the sprite sheet as a Texture
			walkSheet = new Texture(Gdx.files.internal("theseus5.png"));
	...
	public Sprite attacknow() {
		 ...
		 texture = new Texture(Gdx.files.internal("theseusanim1.png"));
		   sprite = new Sprite(texture,0,0,64,64);
		   sprite.flip(false, true);
