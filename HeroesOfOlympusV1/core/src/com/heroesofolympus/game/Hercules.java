...
public class Hercules extends Hero {
	...
	public Hercules(Sprite s, TiledMapTileLayer collisionLayer) {
	...
	public Sprite ownLogic() {
		...
		texture = new Texture(Gdx.files.internal("hercules5.png"));
	...
	public Animation<TextureRegion> takeAction() {
		...
		walkSheet = new Texture(Gdx.files.internal("hercules5.png"));
	...
	public Sprite attacknow() {
		...
		texture = new Texture(Gdx.files.internal("herculesanim.png"));
		sprite = new Sprite(texture,0,0,64,64);
		sprite.flip(false, true);
